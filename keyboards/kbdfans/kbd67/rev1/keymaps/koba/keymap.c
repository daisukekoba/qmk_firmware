...
[0] = LAYOUT_all(
  ...
  KC_LCTL, KC_LGUI, KC_LALT,        KC_SPC,         MO(2),          KC_SPC,          KC_RALT, KC_RCTL, XXXXXXX, KC_LEFT, KC_DOWN, KC_RGHT),
...
[1] = LAYOUT_all(
  ...
  _______, _______, _______,_______,_______,_______,_______,_______,_______,_______, _______, _______, _______,          _______, GA_PSCR, \
   ...
   * |----------------------------------------------------------------|
   * |    |Game|    | Muhenkan |   | Henkan |Kana|Menu|  |Hom|PDn|End |
   * `------------------------------------------------'  `------------'
   */
[2] = LAYOUT_all(
   ...
   _______,TG(1)  ,_______,        KC_MHEN,        _______,        KC_HENK,        KC_KANA,KC_APP, _______,KC_HOME,KC_PGDN,KC_END),
};
